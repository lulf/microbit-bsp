...
use drogue_device::{
    ...
    drivers::ble::mesh::{
        bearer::nrf52::{Nrf52BleMeshFacilities, SoftdeviceAdvertisingBearer, SoftdeviceRng},
        composition::{
        ...
        driver::{elements::AppElementsContext, DeviceError},
        interface::AdvertisingOnlyNetworkInterfaces,
        model::{
            sensor::{
                PropertyId, SensorConfig, SensorData, SensorDescriptor, SensorMessage,
                SensorServer, SensorStatus, SENSOR_SERVER,
            },
            ModelIdentifier,
        },
        pdu::{access::AccessMessage, ParseError},
        provisioning::{
...
mod animation {
    use drogue_device::{
        ...
        drivers::led::matrix::fonts::{frame_5x5, CHECK_MARK, CROSS_MARK},
    };
